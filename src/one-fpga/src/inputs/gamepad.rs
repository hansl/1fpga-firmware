...
pub enum Button {
    ...
    Misc2 = sdl3::gamepad::Button::Misc2 as u8,
    Misc3 = sdl3::gamepad::Button::Misc3 as u8,
    Misc4 = sdl3::gamepad::Button::Misc4 as u8,
    Misc5 = sdl3::gamepad::Button::Misc5 as u8,
...
impl From<sdl3::gamepad::Button> for Button {
    fn from(button: sdl3::gamepad::Button) -> Self {
        match button {
            ...
            sdl3::gamepad::Button::Misc2 => Button::Misc2,
            sdl3::gamepad::Button::Misc3 => Button::Misc3,
            sdl3::gamepad::Button::Misc4 => Button::Misc4,
            sdl3::gamepad::Button::Misc5 => Button::Misc5,
