...
export interface RunOptions {
  ...
  /** The save file path to load (or save to). If missing the core will not use any save file. */
...
export interface OneFpgaCore {
  ...
  /**
   * The core's main loop, sending any inputs to the core, and checking for shortcuts. This function
   * will return when the core is unloaded by the user.
   */
...
let currentCore: OneFpgaCore | null = null;

export async function load(options: RunOptions): Promise<OneFpgaCore> {
