...
function GlobalSettingList() {
  ...
  useEffect(() => {
    send("SELECT key FROM global_storage")
      .then(rows => setKeys(rows.map((r: any) => r.key)));
  }, []);
      ...
      <form method="post" className="mx-auto max-w-4xl">
        ...
        <section className="grid gap-x-8 gap-y-6 px-4 sm:grid-cols-2">
          <div className="space-y-1">
            ...
            <Text>
              Set whether 1FPGA should be connected to the Internet.
              A random IP address will be generated.
            </Text>
          </div>
        ...
        <section className="grid gap-x-8 gap-y-6 px-4 sm:grid-cols-2">
          <div className="space-y-1">
            ...
            <Text className="mb-8">
              Settings that are not associated with a user.
            </Text>
