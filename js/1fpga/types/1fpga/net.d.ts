...
/**
 * This module provides functions for accessing the internet. It can download JSON data or files
 * from URLs.
 */
declare module '1fpga:net' {
  ...
  /**
   * Download a JSON file from a URL. Returns the parsed JSON. Will throw an error if the request
  ...
  /**
   * Download a file from a URL. Returns the file location. Will throw an error if the request
   * fails.
   *
   * @param url The URL to download.
   * @param destination The destination directory. If not provided, a temporary file will be
   *   created.
