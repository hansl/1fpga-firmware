...
/**
 * This module provides functions for interacting with the 1FPGA SQL database. It is free form, so
 * you can execute any SQL query you want. Be careful with updates and schema changes.
 */
declare module '1fpga:db' {
  /**
   * A value that can be bound to or returned from a SQL query. This can be a string, number,
   * boolean, or NULL.
   */
  ...
  /**
   * Gets a database object for the given database name. This will create the database if it does
   * not exist.
   *
  ...
  /**
   * Creates a SQLite database from a file on disk. If the file does not exist, this will create it.
   * If it does exist, loads it as a SQLite file.
   *
