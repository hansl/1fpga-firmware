...
/**
 * This module provides functions to interact with the inner settings of the 1FPGA frontend. This is
 * distinct from the settings that are stored in the local storage.
 */
