...
// import { fetchAndCreateCatalogDbEntry } from '@/services/catalog';
...
// };
//
// async function catalogDetails(c: db.catalog.CatalogRow) {
//   return false;
// }
//
...
//   const has1FpgaCatalog = await db.catalog.exists(WellKnownCatalogs.OneFpga);
//   const choices = ['Custom URL', ...(has1FpgaCatalog ? [] : ['1FPGA']), 'Cancel'];
//
//   const choice = await osd.alert({
//     title: 'Add a new Catalog',
//     message: 'Do you want to add a well-known catalog (if available), or enter a URL?',
//     choices,
//   });
//   if (choice === null) {
//     return false;
...
//     case 1:
//       if (has1FpgaCatalog) {
//         const catalog = await fetchAndCreateCatalogDbEntry(WellKnownCatalogs.OneFpga);
...
// }
//
// export async function installCoresFromCatalog(remote: RemoteCatalog, catalog: Catalog) {
